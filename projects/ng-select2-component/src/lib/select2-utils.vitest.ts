...
describe('Select2Utils', () => {
    ...
    describe('patternUnicode', () => {
        it('should return a pattern whit "a"', () => {
            expect(Select2Utils.patternUnicode('a')).toBe(
                '((a|[ⓐａẚàáâầấẫẩãāăằắẵẳȧǡäǟảåǻǎȁȃạậặḁąⱥɐ])[\\u0300-\\u036F]*)',
            );
        });

        it('should return a pattern whit "coeur"', () => {
            expect(Select2Utils.patternUnicode('coeur')).toBe(
                '((c|[ⓒｃćĉċčçḉƈȼꜿↄ])[\\u0300-\\u036F]*)((oe|œ)[\\u0300-\\u036F]*)((u|[ⓤｕùúûũṹūṻŭüǜǘǖǚủůűǔȕȗưừứữửựụṳųṷṵʉ])[\\u0300-\\u036F]*)((r|[ⓡｒŕṙřȑȓṛṝŗṟɍɽꝛꞧꞃ])[\\u0300-\\u036F]*)',
            );
        });
        ...
        it('should return a pattern whit "ÉCŒURÉ"', () => {
            expect(Select2Utils.patternUnicode('ÉCŒURÉ')).toBe(
                '((e|(?<!((o|[ⓞｏòóôồốỗổõṍȭṏōṑṓŏȯȱöȫỏőǒȍȏơờớỡởợọộǫǭøǿɔƟꝋꝍɵ])[\\u0300-\\u036F]*))[eⓔｅèéêềếễểẽēḕḗĕėëẻěȅȇẹệȩḝęḙḛɇɛǝ])[\\u0300-\\u036F]*)((c|[ⓒｃćĉċčçḉƈȼꜿↄ])[\\u0300-\\u036F]*)((oe|œ)[\\u0300-\\u036F]*)((u|[ⓤｕùúûũṹūṻŭüǜǘǖǚủůűǔȕȗưừứữửựụṳųṷṵʉ])[\\u0300-\\u036F]*)((r|[ⓡｒŕṙřȑȓṛṝŗṟɍɽꝛꞧꞃ])[\\u0300-\\u036F]*)((e|(?<!((o|[ⓞｏòóôồốỗổõṍȭṏōṑṓŏȯȱöȫỏőǒȍȏơờớỡởợọộǫǭøǿɔƟꝋꝍɵ])[\\u0300-\\u036F]*))[eⓔｅèéêềếễểẽēḕḗĕėëẻěȅȇẹệȩḝęḙḛɇɛǝ])[\\u0300-\\u036F]*)',
            );
        });
    });
});
