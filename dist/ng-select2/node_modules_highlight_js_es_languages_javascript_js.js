"use strict";
(self["webpackChunkng_select2"] = self["webpackChunkng_select2"] || []).push([["node_modules_highlight_js_es_languages_javascript_js"],{
...
function javascript(hljs) {
  ...
  const SUBST_INTERNALS = [hljs.APOS_STRING_MODE, hljs.QUOTE_STRING_MODE, HTML_TEMPLATE, CSS_TEMPLATE, TEMPLATE_STRING,
  ...
  return {
    ...
    contains: [hljs.SHEBANG({
      ...
      binary: "node",
      relevance: 5
    }), USE_STRICT, hljs.APOS_STRING_MODE, hljs.QUOTE_STRING_MODE, HTML_TEMPLATE, CSS_TEMPLATE, TEMPLATE_STRING, COMMENT,
    // Skip numbers when they are part of a variable name
    {
      match: /\$\d+/
...
//# sourceMappingURL=node_modules_highlight_js_es_languages_javascript_js.js.map